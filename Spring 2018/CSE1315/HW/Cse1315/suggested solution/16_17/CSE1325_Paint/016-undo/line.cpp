...
Line::Line(double p_x1, double p_y1,double p_x2, double p_y2, Gdk::RGBA p_color, double p_width, int p_dash) 
        : _x1{p_x1}, _y1{p_y1}, _x2{p_x2}, _y2{p_y2}, _color{p_color}, _width{p_width}, _dash{p_dash}  { }
