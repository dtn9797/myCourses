...
std::string Library::patron_to_string(int patron_index) {
  return patrons[patron_index].to_string();
}

std::vector<std::string> Library::publication_to_strings(int publication_index) {
  return publications[publication_index].to_strings();
}
