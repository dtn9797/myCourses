...
int Controller::number_of_pubs() {return library.number_of_publications();}
std::vector<std::string> Controller::pub_to_strings(int index) {return library.publication_to_strings(index);}
